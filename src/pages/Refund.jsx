  ...
  return (
    <div className="main-refund">
      ...
      <p>
        ...
        <br />
        <br /> We will immediately notify you on the status of your refund after
        inspecting the item.
        <br /> If your return is approved, we will initiate a refund to your
        method of payment(Credit Card/Debit Card/Bank etc).
        <br />
        <br /> You will receive the credit within a certain amount of days,
      ...
      <h3>Contact Us</h3>
      <p>If you have any questions on how to return your item to us, contact us at 9999999999</p>
    </div>
  );
};
